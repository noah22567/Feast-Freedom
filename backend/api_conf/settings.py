"""
Django settings for api_conf project.
...
INSTALLED_APPS = [
    ...
    'django.contrib.messages', 'django.contrib.staticfiles', 'provider', 'user'
]
...
WSGI_APPLICATION = 'api_conf.wsgi.application'
